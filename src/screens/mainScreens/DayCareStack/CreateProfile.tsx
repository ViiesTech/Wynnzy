  ...
  return (
    <ScrollView
      ...
      <View style={{alignSelf: 'center', marginTop: responsiveHeight(4)}}>
        <Image
          source={imageUri ? {uri: imageUri} : images.profilePic}
          style={{
      ...
      <View style={{marginTop: responsiveHeight(4), gap: responsiveHeight(2)}}>
        ...
        <Input
          ...
          showPassword
          handlePress={text => handleInputChange('contactNo', text)}
          icon={true}
          elevation={false}
          xml={user}
          placeHolder="Contact Number(Without Dash)"
          placeholderTxtColor="#3b4b68"
        />
        <TextInput
          multiline
