      ...
      <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
        <View style={{flexDirection: 'row', gap: responsiveHeight(1)}}>
          <Image
            ...
            source={{
              uri: `${ImageBaseUrl}${data ? data?.images[0] : imageUrl}`,
            }}
          />
          <View
            ...
            <BoldText
              ...
              fontWeight="600"
              title={data ? data?.serviceName : serviceName}
            />
            <NormalText
              fontSize={responsiveFontSize(1.5)}
              color="#9DA5B3"
              title={data ? data?.description : description}
            />
            <View style={{gap: 10, marginTop: 5}}>
              ...
              <View
                ...
                <NormalText
                  ...
                  color="#9DA5B3"
                  alignSelf="none"
                  title={data ? data?.address : address}
                />
              </View>
            </View>
          </View>
