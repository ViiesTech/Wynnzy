...
const Header2 = ({ handlePress }) => {
  return (
    <TouchableOpacity onPress={() => Alert.alert('working')} style={styles.headerView}>
...
export const Header3: React.FC<Header3Props> = ({ textContainer = true, rightIcon, firstRightIcon = true, onEditPress }) => {
  return (
    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <View style={{}}>
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: responsiveHeight(1) }}>
              ...
              <TouchableOpacity>
                ...
                <Ionicons name="chevron-down-outline" color={Colors.buttonBg} size={18} />
              </TouchableOpacity>
            </View>
            <NormalText fontWeight="700" color={'#131e5e'} title="location street, ID" />
          </View>
        )}
      </View>
      <View style={{ flexDirection: 'row', alignItems: 'center', gap: responsiveHeight(1.5) }}>
        ...
        <TouchableOpacity onPress={onEditPress}>
          <SvgIcons xml={rightIcon ? rightIcon : notifyTheme} height={30} width={30} />
        </TouchableOpacity>
      </View>
    </View>
  );
